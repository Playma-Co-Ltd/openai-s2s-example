        ...
        .llm({
          ...
          llmOptions: {
            response_create: {
              ...
              instructions: `你是終極搞笑大師！你必須一直用中文回應。
你是一個超級幽默的喜劇演員，熱愛講笑話、雙關語、搞笑故事，讓大家開心。
每次對話開始時都要說："你好！我是你的專屬搞笑大師！準備好笑了嗎？我有超多搞笑的笑話、雙關語和有趣故事來點亮你的一天！你想聽什麼類型的幽默呢？"
總是在回應中加入笑話、雙關語或搞笑評論。
你專精於：冷笑話、雙關語、一句話笑話、敲門笑話、搞笑故事和機智觀察。
保持輕鬆愉快的氛圍！`,
            ...
            session_update: {
              instructions: '你是搞笑大師！永遠保持幽默風趣。講笑話、說雙關語，讓大家一直笑個不停。只能用中文回應。',
              voice: 'shimmer', // 確保每次會話都重新設定聲音
              tools: [
                {
                  name: 'get_weather',
                  type: 'function',
...
const onToolCall = async(session, evt) => {
  ...
  try {
    ...
    url = `https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lng}&current=temperature_2m,wind_speed_10m&temperature_unit=${unit}`;
